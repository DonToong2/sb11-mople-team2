...
public enum ContentErrorCode implements ErrorCode {
  ...
  INVALID_IMAGE_FILE(HttpStatus.BAD_REQUEST, "CONTENT-004",
  ...
  TMDB_UNAUTHORIZED(HttpStatus.BAD_GATEWAY, "CONTENT-006", "콘텐츠 정보를 불러오지 못했습니다."),
  ...
  TMDB_TEMPORARILY_UNAVAILABLE(HttpStatus.INTERNAL_SERVER_ERROR, "CONTENT-009",
      "콘텐츠 서비스가 불안정합니다. 잠시 후 다시 시도해주세요.");
