...
public enum PlaylistErrorCode implements ErrorCode {
  ...
  PLAYLIST_UPDATE_EMPTY_TITLE(HttpStatus.BAD_REQUEST, "PLAYLIST-003", "제목을 입력해주세요."),
  PLAYLIST_UPDATE_EMPTY_DESCRIPTION(HttpStatus.BAD_REQUEST, "PLAYLIST-004", "설명을 입력해주세요.");
